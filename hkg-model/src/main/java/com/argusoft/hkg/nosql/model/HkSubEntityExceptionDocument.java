 ...
 * @author dhwani
 */
@Document(collection = "subentityexception")
public class HkSubEntityExceptionDocument {
    
    @Id
    private ObjectId id;
    private List<String> forUsers;
    private List<ObjectId> forValues;
    ...
    public List<ObjectId> getForValues() {
        return forValues;
    }

    public void setForValues(List<ObjectId> forValues) {
    ...
    public String toString() {
        return "HkSubEntityExceptionDocument{" + "id=" + id + ", forUsers=" + forUsers + ", forValues=" + forValues + ", fieldId=" + fieldId + ", fieldType=" + fieldType + ", instanceId=" + instanceId + ", dependsOnValueList=" + dependsOnValueList + ", dependsOnSubValueList=" + dependsOnSubValueList + ", isArchive=" + isArchive + ", franchise=" + franchise + ", createdBy=" + createdBy + ", createdOn=" + createdOn + ", lastModifiedBy=" + lastModifiedBy + ", lastModifiedOn=" + lastModifiedOn + '}';
    }
