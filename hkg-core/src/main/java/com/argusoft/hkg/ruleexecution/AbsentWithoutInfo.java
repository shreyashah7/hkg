 ...
 * @author siddharth
 */
public class AbsentWithoutInfo extends Operation {

    public AbsentWithoutInfo() {
        super("awi");
    }

    @Override
    public AbsentWithoutInfo copy() {
        return new AbsentWithoutInfo();
    }
    ...
    public boolean interpret(Map<String, ?> bindings, Map<String, String> type, Map<String, String> componentTypes) {
        ...
        System.out.println("AbsentWithoutInfo ----- obj----" + obj);
        if (obj == null) {
