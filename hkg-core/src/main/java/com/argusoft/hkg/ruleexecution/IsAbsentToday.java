 ...
 * @author siddharth
 */
public class IsAbsentToday extends Operation {

    public IsAbsentToday() {
        super("iat");
    }

    @Override
    public IsAbsentToday copy() {
        return new IsAbsentToday();
    }
    ...
    public boolean interpret(Map<String, ?> bindings, Map<String, String> type, Map<String, String> componentTypes) {
        ...
        System.out.println("IsAbsentToday ----- obj----" + obj);
        if (obj == null) {
