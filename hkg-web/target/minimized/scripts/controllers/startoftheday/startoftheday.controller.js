define(["hkg","startOfTheDayService","customFieldService","assetService","ngload!uiGrid","addMasterValue","customsearch.directive","printBarcodeValue","dynamicForm","accordionCollapse"],function(b,c,a){b.register.controller("StartOfTheDayController",["$rootScope","$scope","StartOfTheDayService","DynamicFormService","AssetService","$q","$timeout",function(d,h,k,g,f,e,j){var i={};
d.mainMenu="stockLink";
d.childMenu="startofDay";
d.activateMenu();
...
h.selectedTab="Issue"
}}}}if(h.flag.rowSelectedflag===true){h.nextScreen()
}};
