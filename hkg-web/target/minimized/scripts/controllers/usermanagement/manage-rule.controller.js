define(["hkg","ruleService"],function(a,b){a.register.controller("RuleController",["$rootScope","$scope","RuleService","$log","$templateCache",function(e,g,f,h,d){e.maskLoading();
...
function c(){f.retrievePrerequisite(function(k){console.log("entity::"+JSON.stringify(k.entity));
console.log("allrules::"+JSON.stringify(k.allrules))
});
var j={primaryKey:"54783ec644a29a8fc2936b80"};
f.retrieveRuleById(j,function(k){console.log("retrieve by id......:::"+JSON.stringify(k))
})
