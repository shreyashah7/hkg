...
public class RbTabularRelationDataBean {
    ...
    public String toString() {
        return "RbTabularRelationDataBean{" + "id=" + id + ", relationLeftToRight=" + relationLeftToRight + ", table1=" + table1 + ", table1Column=" + table1Column + ", table2=" + table2 + ", table2Column=" + table2Column + ", joinTable=" + joinTable + ", joinColumnTable1=" + joinColumnTable1 + ", joinColumnTable2=" + joinColumnTable2 + '}';
    }
}
