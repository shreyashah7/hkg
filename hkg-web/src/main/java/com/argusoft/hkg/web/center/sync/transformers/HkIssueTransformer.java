 ...
 */
@Service
public class HkIssueTransformer extends SyncTransformerAdapter {
    ...
    public void save(Object object) {
        if (object != null && object instanceof HkIssueDocument) {
            HkIssueDocument document = (HkIssueDocument) object;
            HkIssueDocument currentDocument = (HkIssueDocument) hkUMSyncService.getDocumentById(document.getId(), HkIssueDocument.class);
    ...
    public Object convertEntityToDocument(Object entityObject) {
        HkIssueDocument document = null;
        if (entityObject != null && entityObject instanceof HkIssueDocument) {
            document = (HkIssueDocument) entityObject;
