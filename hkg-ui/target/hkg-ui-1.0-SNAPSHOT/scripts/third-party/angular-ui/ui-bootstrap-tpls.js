...
angular.module('ui.bootstrap.dateparser', [])
        ...
        .service('dateParser', ['$locale', 'orderByFilter', function($locale, orderByFilter) {
                ...
                //Replicate of above parser but added regex to support two or one digit in date and month
                //Similarly two digit for year.
                ...
                this.parse = function(input, format) {
                    ...
                    if (!this.parsers[format]) {
                        this.parsers[format] = customParser(format);
                    }
...
angular.module('ui.bootstrap.datepicker', ['ui.bootstrap.dateparser', 'ui.bootstrap.position'])
        ...
        .controller('DatepickerController', ['$scope', '$attrs', '$parse', '$interpolate', '$timeout', '$log', 'dateFilter', 'datepickerConfig', function($scope, $attrs, $parse, $interpolate, $timeout, $log, dateFilter, datepickerConfig) {
                ...
                angular.forEach(['formatDay', 'formatMonth', 'formatYear', 'formatDayHeader', 'formatDayTitle', 'formatMonthTitle',
                    ...
                    self[key] = angular.isDefined($attrs[key]) ? (index < 8 ? $interpolate($attrs[key])($scope.$parent.$parent) : $scope.$parent.$parent.$eval($attrs[key])) : datepickerConfig[key];
                });

                // Watchable date attributes
                angular.forEach(['min', 'max'], function(key) {
                    if ($attrs[key]) {
                        $scope.$parent.$parent.$watch($parse($attrs[key]), function(value) {
                ...
                this.activeDate = angular.isDefined($attrs.initDate) ? $scope.$parent.$parent.$eval($attrs.initDate) : new Date();
                ...
                this.isDisabled = function(date) {
                    return ((this.min && this.compare(date, this.min) < 0) || (this.max && this.compare(date, this.max) > 0) || ($attrs.dateDisabled && $scope.dateDisabled({date: date, mode: $scope.datepickerMode})));
                };
            ...
            function($compile, $parse, $document, $position, dateFilter, dateParser, datepickerPopupConfig) {
                return {
                    ...
                    link: function(scope, element, attrs, ngModel) {
                        ...
                        //Changes done after pull request- https://github.com/angular-ui/bootstrap/pull/1915 to support ng-if
                        //in date picker
                        scope.popup = {};
                        ...
                        var popupEl = angular.element('<div datepicker-popup-wrap><div datepicker is-open="isOpen"></div></div>');
                        popupEl.attr({
                            'ng-model': 'popup.date',
                        ...
                        scope.watchData = {};
                        angular.forEach(['min', 'max', 'datepickerMode'], function(key) {
                            if (attrs[key]) {
                            ...
                            compile: function(tElem, tAttrs) {
                                ...
                                return function link(scope, element, attrs) {
                                    ...
                                    function show() {
                                        ...
                                        //Check if element is on right side of screen, then shift tooltip to left.
                                        var clw = (window.innerWidth || document.documentElement.clientWidth);
                                        var position = offset(element);
                                        if (position.left > clw - (tooltip.prop('offsetWidth') || 200)) {
                ...
                this.setupInputEvents = function(hoursInputEl, minutesInputEl) {
                    ...
                    $scope.updateHours = function() {
                        ...
                        if (angular.isDefined(hours)) {
                            ...
                            selected.setHours(new Date().getHours());
                            invalidate(true);
                        }
                    };
        ...
        .directive('timepicker', function() {
            return {
                ...
                link: function(scope, element, attrs, ctrls) {
                    ...
                    scope.removeRequired = attrs.removeRequired;
                    if (ngModelCtrl) {
...
angular.module("template/datepicker/datepicker.html", []).run(["$templateCache", function($templateCache) {
        $templateCache.put("template/datepicker/datepicker.html",
                "<div><div ng-if=\"isOpen\"><div ng-switch=\"datepickerMode\" role=\"application\" ng-keydown=\"keydown($event)\">\n" +
