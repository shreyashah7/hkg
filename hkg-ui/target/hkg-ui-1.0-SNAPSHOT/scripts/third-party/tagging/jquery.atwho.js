...
//                console.log("startOffset::" + sel.getRangeAt(0).startOffset);
...
//                console.log("this.query.end_pos" + this.query.end_pos);
//                console.log("this.query.head_pos" + this.query.head_pos);
//                console.log("this.at.length" + this.at.length);
...
//                    wrapped_content = "<span>" + content + "</span>";
                } else {
//                    suffix = "<span contenteditable='false'>" + suffix + "</span>";
//                    wrapped_content = "<span contenteditable='false'>" + content + suffix + "</span>";
//                    wrapped_content = "<span contenteditable='false'>" + content + "</span>";
                }
