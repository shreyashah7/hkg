...
!function(a, b) {
    ...
    b.factory("ngTableParams", ["$q", function(b) {
            var c = function(a) {
                ...
                this.parameters = function(b, d) {
                    ...
                    return a.isDefined(b) ? this.parameters({page: b}) : g.page
                }, this.total = function(b) {
                    var c = a.isDefined(b) ? this.settings({total: b}) : h.total;
                    return a.isFunction(c) ? c() : c
                }, this.count = function(b) {
                    return a.isDefined(b) ? this.parameters({count: b, page: 1}) : g.count
                }, this.filter = function(b) {
                    return a.isDefined(b) ? this.parameters({filter: b}) : g.filter
                }, this.sorting = function(b) {
                    return a.isDefined(b) ? this.parameters({sorting: b}) : g.sorting
                }, this.orderBy = function() {
                    var a = [];
                    for (var b in g.sorting)
                        a.push(("asc" === g.sorting[b] ? "+" : "-") + b);
                    return a
                    ...
                    e.promise.then(function(b) {
                        ...
                        for (var f in b) {
                            ...
                            e[h] = e[h] || {data: []}, e[h].value = h, e[h].data.push(g)
                        }
                        var i = [];
                        for (var j in e)
                            i.push(e[j]);
                    ...
                    if (d = 11, j = [], h = Math.ceil(b / c), h > 1) {
                        for (j.push({type:"prev", number:Math.max(1, a - 1), active:a > 1}), j.push({type:"first", number:1, active:a > 1}), f = Math.round((d - 5) / 2), g = Math.max(2, a - f), e = Math.min(h - 1, a + 2 * f - (a - g)), g = Math.max(2, g - (2 * f - (e - g))), i = g; e >= i; )
                            i === g && 2 !== i || i === e && i !== h - 1 ? j.push({type: "more", active: !1}) : j.push({type: "page", number: i, active: a !== i}), i++;
                    ...
                    for (key in g)
                        if (g.hasOwnProperty(key)) {
                            ...
                            if ("object" == typeof d) {
                                ...
                                a.isFunction(d) || a.isUndefined(d) || "" === d || (b ? c.push(e + "=" + encodeURIComponent(d)) : c[e] = encodeURIComponent(d))
                        }
                    return c
                ...
                var g = this.$params = {page: 1, count: 1, filter: {}, sorting: {}, group: {}, groupBy: null}, h = {$scope: null, $loading: !1, total: 0, counts: [10, 25, 50, 100], getGroups: this.getGroups, getData: this.getData};
    ...
    var c = ["$scope", "ngTableParams", "$q", function(a, b) {
            a.$loading = !1, a.params || (a.params = new b), a.params.settings().$scope = a, a.$watch("params.$params", function() {
                ...
                var c, d;
                b.sortable && (c = a.params.sorting() && a.params.sorting()[b.sortable] && "desc" === a.params.sorting()[b.sortable], d = {}, d[b.sortable] = c ? "asc" : "desc", a.params.parameters({sorting: d}))
            }
        }];
            ...
            return{restrict: "A", priority: 1001, scope: !0, controller: c, compile: function(c) {
                    ...
                    return a.forEach(a.element(c[0].querySelector("tr:not(.ng-table-group)")).find("td"), function(b) {
                        ...
                        if (!c.attr("ignore-cell") || "true" !== c.attr("ignore-cell")) {
                            var g = function(a) {
                                return e(c.attr("x-data-title") || c.attr("data-title") || c.attr("title"))(a, {$columns: d}) || " "
                            };
                            c.attr("data-title-text", g());
                            var h = function(a) {
                                return e(c.attr("x-data-header") || c.attr("data-header") || c.attr("header"))(a, {$columns: d}) || !1
                            }, i = c.attr("filter") ? e(c.attr("filter"))() : !1, j = !1;
                            i && i.templateURL && (j = i.templateURL, delete i.templateURL), d.push({id: f++, title: g, sortable: c.attr("sortable") ? c.attr("sortable") : !1, filter: i, filterTemplateURL: j, headerTemplateURL: h, filterData: c.attr("filter-data") ? c.attr("filter-data") : null, show: c.attr("ng-show") ? function(a) {
