define(['hkg', 'endOfTheDayService', 'ngload!uiGrid', 'addMasterValue', 'customsearch.directive', 'printBarcodeValue', 'dynamicForm', 'assetService', 'accordionCollapse'], function(hkg, endOfTheDayService, assetService) {
    hkg.register.controller('EndOfTheDayController', ["$rootScope", "$scope", "EndOfTheDayService", "DynamicFormService", "AssetService", "$q", "$timeout", function($rootScope, $scope, EndOfTheDayService, DynamicFormService, AssetService, $q, $timeout) {
            var featureMap = {};
            $rootScope.mainMenu = "stockLink";
            $rootScope.childMenu = "endofDay";
                ...
                templateData.then(function(section) {
                    ...
                    $scope.generateFeatureMap(function() {
                        if (!!$scope.generalSearchTemplate) {
                            ...
                            EndOfTheDayService.retrieveIssuestocks(featureMap, function(result) {
...
//                                console.log("retrieveIssuestocks----" + JSON.stringify(result));
                                ...
                                EndOfTheDayService.retrieveRecievestocks(featureMap, function(result) {
...
//                                    console.log("retrieveRecievestocks---" + JSON.stringify(result));
                                    ...
                                    EndOfTheDayService.retrieveReturnstocks(featureMap, function(result) {
...
//                    $scope.selectedTab = {};
                ...
                EndOfTheDayService.retrieveFieldSequenceMap(function(res) {
...
//                allowClear: true,
                ...
                query: function(query) {
                    ...
                    EndOfTheDayService.retrieveUsersForCarrierBoysId(selected.trim(), success, failure);
                }
            };
...
//                    console.log("$scope.issueStockList :" + JSON.stringify($scope.issueStockList));
                    ...
                    payload.department = $scope.issueDataBean.inStockOfDepartment;
//                    console.log("payload----" + JSON.stringify(payload));
                    EndOfTheDayService.issueLotsOrPackets(payload, function(response) {
                        $scope.flag.homePage = true;
...
//                console.log("recieve method called");
                ...
                if (recieveLotOrPacketForm.$valid) {
                    ...
                    payload.uniqueScannedIds = barcodes;
//                    console.log("payload----" + JSON.stringify(payload));
                    EndOfTheDayService.recieveLotsOrPackets(payload, function(response) {
                        $scope.flag.homePage = true;
//                        console.log("response----" + JSON.stringify(response));
                        if (response.hasOwnProperty("success")) {
...
//                console.log("returnSubmit method called");
                ...
                if (returnLotOrPacketForm.$valid) {
                    ...
                    payload.uniqueScannedIds = barcodes;
//                    console.log("payload----" + JSON.stringify(payload));
                    EndOfTheDayService.returnLotsOrPackets(payload, function(response) {
                        $scope.flag.homePage = true;
//                        console.log("response----" + JSON.stringify(response));
                        if (response.hasOwnProperty("success")) {
