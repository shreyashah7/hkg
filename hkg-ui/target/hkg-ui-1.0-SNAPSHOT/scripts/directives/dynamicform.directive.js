...
define(['angular', 'webcam', 'datepickercustom.directive'], function () {
    globalProvider.compileProvider.directive('dynamicForm', ['$q', '$parse', '$http', '$templateCache', '$compile', '$document', '$timeout', '$rootScope', '$filter', 'CustomHolidayService', 'CenterCustomHolidayService',
...
//                'button': {element: 'button', type: 'button', editable: false, textBased: false, class: "btn btn-hkg "},
                ...
                'currency': {element: 'input', type: 'hidden', editable: true, textBased: false},
                'exchangeRate': {element: 'input', type: 'hidden', editable: true, textBased: false},
                'fileUpload': {element: 'input', type: 'hidden', editable: true, textBased: false},
            ...
            var link = function ($scope, element, attrs, ctrls) {
                ...
                var render = function (callback) {
                    ...
                    var newElement = null,
                            ...
                            model = null,
                            dtbMap = null,
                            evaluateResultConstraint = false,
...
//                                        dtbMap[field.model + "@CurrencyValue"] = field.dbType;
                                    ...
                                    if (!angular.isDefined(supported[field.type]) || supported[field.type] === false) {
                                        ...
                                        if (angular.isDefined(field.label)) {
                                            angular.element(newElement.html(rootScope.translateValue("CSTMFLD_NM." + field.label)));
...
//                                            newElement = newElement.append('{{' + attrs.ngModel + "['from" + field.model + "']" + '}}' + '{{' + attrs.ngModel + "['to" + field.model + "']" + '}}');
                                            ...
                                            else if (field.type === 'checkbox')
                                            {
                                                ...
                                                var imageFullString = $scope[attrs.ngModel][field.model];
                                                if ($scope[attrs.ngModel][field.model] !== null && $scope[attrs.ngModel][field.model] !== undefined)
                                                {
                                                    var imageForThumbnailString = $scope[attrs.ngModel][field.model].substring(0, $scope[attrs.ngModel][field.model].lastIndexOf("."));
                                                ...
                                                if ($scope[attrs.ngModel][field.model] !== null && $scope[attrs.ngModel][field.model] !== undefined)
                                                {
                                                    var thumbnailElement = angular.element("<img alt='Image' style='position:relative' height='42' width='42' ng-src='api/fileUpload/getimage?file_name={{ \"" + thumbnailString + "\"}}&token={{authToken}}' ng-click='showImagePopup( \"" + thumbnailString + "\")'></img>");
                                            ...
                                            if (field.type === 'select' || field.type === 'pointerselect') {
                                                var selectId = $scope[attrs.ngModel][field.model];
                                                ...
                                                {
                                                    var select = $scope[attrs.ngModel][field.model].toString();
                                                    var selectUrl;
                                            ...
                                            if (field.type === 'subEntity') {
                                                var subEntityId = $scope[attrs.ngModel][field.model];
                                                if (attrs.uniqueIdView !== null && attrs.uniqueIdView !== undefined)
                                                {
                                                    uniqueId = attrs.uniqueIdView + field.model;
                                                } else
                                                ...
                                                {
                                                    var subEntity = $scope[attrs.ngModel][field.model].toString();
                                            ...
                                            if (field.type === 'multiSelect' || field.type === 'pointer_multiSelect') {
                                                var multiSelectId = $scope[attrs.ngModel][field.model];
                                                if (attrs.uniqueIdView !== null && attrs.uniqueIdView !== undefined)
                                                {
                                                    uniqueId = attrs.uniqueIdView + field.model;
                                                } else
                                                ...
                                                {
                                                    var multiselect = $scope[attrs.ngModel][field.model].toString();
                                            ...
                                            if (field.type === 'UserMultiSelect') {
                                                ...
                                                if ($scope[attrs.ngModel][field.model] !== null && $scope[attrs.ngModel][field.model] !== undefined)
                                                {
                                                    var multiSelectId = $scope[attrs.ngModel][field.model].toString();
...
//                                            alert("fff" + format('#,###.00', '2325'));
                                                ...
                                                else if(field.currencySymbolPosition !== null && field.currencySymbolPosition !== undefined && field.currencySymbolPosition === false)
                                                {
                                                    symbolElement.append(" " + currencySymbol);
                                            ...
                                            else if (field.type === 'text')
                                            {
                                                if (angular.isDefined(field.masked) && field.masked) {
                                                    ...
                                                    if (rootScope.viewEncryptedData === false)
                                                    {
                                                        if ($scope[attrs.ngModel][field.model] !== null && $scope[attrs.ngModel][field.model] !== undefined)
                                                        {
                                                            var textElement = $scope[attrs.ngModel][field.model];
                                                            var encrypt = '~';
...
//                                                    model[field.model] = angular.copy(field.val);
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        if ($scope[attrs.ngModel][field.model] === undefined)
                                                        {
                                            ...
                                            if (angular.isDefined(supported[field.type].textBased) && supported[field.type].textBased) {
                                                ...
                                                if (angular.isDefined(field.maxLength)) {
                                                    console.log("field.maxLength :" + field.maxLength)
                                            ...
                                            if (field.isUnique === true) {
                                                ...
                                                $scope.$watch(textValue, function () {
                                                    $scope[textValue] = $scope[attrs.ngModel][field.model];
...
// Date
                                            if (field.type === 'date') {
                                                //console.log("in field dateee...." + JSON.stringify(field))
//                                                newElement.attr('ng-controller', 'DefaultController');
...
//                                                newElement.attr('ng-init', "defineLabel(\"" + field.model + "\",\"" + field.featureName + "\",\"" + attrs.isDiamond + "\",\"" + attrs.editFlag + "\",\"true\",\"" + field.skipHolidays + "\")");
                                                if (angular.isDefined($scope.screenRules[field.model])) {
                                                    newElement.attr('background-color', $scope.screenRules[field.model].colorCode);
                                                }
                                                else if (angular.isDefined(field.backgroundColor)) {
                                                    newElement.attr('background-color', field.backgroundColor);
                                                } else {
                                                    newElement.removeAttr('style');
                                                }
                                                ...
                                                //console.log("date fieldsss" + JSON.stringify(field))
...
//                                                if (field.mapForDefaultDate !== null && field.mapForDefaultDate !== undefined)
//                                                {
//                                                    //console.log("addd defaulttttt")
//                                                    newElement.attr('ng-controller', 'DefaultController');
//                                                    newElement.attr('ng-init', "defineLabel(\"" + field.model + "\",\"" + field.featureName + "\",\"" + attrs.isDiamond + "\",\"" + attrs.editFlag + "\",\"true\",\"" + true + "\")");
//                                                }
...
// Code added By Shifa Salheen on 21 Feb for formula evaluation if in formula number component is involved
                                                ...
                                                $scope.$watch(numValue, function () {
                                                    console.log("in watch num" + JSON.stringify(field.formulaRoundOff))
                                                    $scope[numValue] = $scope[attrs.ngModel][field.model];

                                                    if (field.isInvolvedInFormula === true)
                                                    {
                                                        if (numValue !== undefined && numValue !== null && $scope[attrs.ngModel] !== undefined)
                                                        {
...
//                                                if (angular.isDefined(field.val) && (field.val === true || field.val === 'true')) {
                                                model[field.model] = angular.copy(field.val);
//                                                }
                                                if (angular.isDefined($scope.screenRules[field.model])) {
                                                    newElement.attr('style', 'background-color:' + $scope.screenRules[field.model].colorCode);
                                                    ...
                                                    newElement.attr('style', 'background-color:' + field.backgroundColor);
                                                } else {
                                                    newElement.removeAttr('style');
                                                }
...
// added by Shifa as previous component was not working
                                            ...
                                            {
                                                console.log("in field..." + JSON.stringify(field))
                                                if (angular.isDefined($scope.screenRules[field.model])) {
                                                    newElement.attr('style', 'background-color:' + $scope.screenRules[field.model].colorCode);
                                                }
                                                else if (angular.isDefined(field.backgroundColor)) {
...
// Don't add options if it has exceptions
                                                } else {
                                                ...
                                                if (field.model !== 'carate_range_of_lot$DRP$Long' && field.model !== 'carate_range_of_packet$DRP$Long' && field.model !== 'machine_to_process_in') {
                                                    newSubt = '<div class="hkg-nopadding" ng-class="{\'col-md-10\':canAccess(\'addMasterValueShortcut\'),\'col-md-12\':!canAccess(\'addMasterValueShortcut\')}"></div>';
                                                } else {
                                                    newSubt = '<div class="hkg-nopadding" class="col-md-12"></div>';
                                                }
                                                ...
                                                if (field.model !== 'carate_range_of_lot$DRP$Long' && field.model !== 'carate_range_of_packet$DRP$Long' && field.model !== 'machine_to_process_in$DRP$Long') {
                                                    newElement.append('<add-master-value ng-show="canAccess(\'addMasterValueShortcut\')" class="col-md-2" records="dropdown" model-value="' + singleSelectValue + '" master-code="{{fieldId}}" is-diamond ="' + attrs.isDiamond + '" is-custom="true" is-dropdown="true" modal-name="' + field.modelWithoutSeperators + '"></add-master-value>');
                                                }
                                                else
                                                {
                                                ...
                                                $scope.$watch(singleSelectValue, function () {
                                                    //////console.log("in watch" + field.model + " VAlue::" + $scope[attrs.ngModel][field.model]);
                                                    if ($scope[attrs.ngModel] !== undefined && $scope[attrs.ngModel] !== null) {
...
//                                                          
// Set option values in the particular elemnt select component                                                           
...
//                                                                                        $scope[attrs.ngModel][modelDrp] = "";
                                                                        ...
                                                                        {
                                                                            // If they don't have exception,then remove the options which were filled by previous exceptions
                                                                            var modelDrp = res.commonId.toString();
                                                                            var seocndElemSplit = modelDrp.split("$");
                                                                            var dropElemnt = angular.element(document.querySelector('#' + seocndElemSplit[0]));
                                                                            var dropOptElemnt = angular.element(document.querySelector('#' + seocndElemSplit[0]));
...
//                                          
                                                ...
                                                $scope.$watch(attrs.rapCalcyData, function (newVal, oldVal) {
                                                    var tmpl = $parse(attrs.template)($scope);
                                                    var tmplFlg = true;
                                                    //Check if there is any change in data of primary section and carat or not

                                                    if (tmpl !== undefined && tmpl !== null && oldVal !== undefined && oldVal !== null && newVal !== undefined && newVal !== null) {
                                                        for (var index2 = 0; index2 < tmpl.length; index2++) {
                                                            if (oldVal[tmpl[index2].model] !== newVal[tmpl[index2].model]) {
                                                                tmplFlg = false;
                                                                break;
                                                            }
                                                        }
                                                    ...
                                                    if (tmplFlg) {
                                                        $timeout(function () {
                                                            if (newVal !== undefined && newVal !== null && attrs.ruleData !== undefined && attrs.ruleData !== null) {
                                                                if (attrs.ruleData) {
                                                                    var dts = JSON.parse(JSON.stringify(eval("(" + attrs.ruleData + ")")));
                                                                    //Loop through all rules
                                                                    for (var itemFlg = 0; itemFlg < dts.length; itemFlg++) {
                                                                        var item = dts[itemFlg];
                                                                        var condFlag = true;
                                                                        var allKeys = Object.keys(item.cond);
                                                                        //Check if condition is fullfilled or not
                                                                        for (var index = 0; index < allKeys.length; index++) {
                                                                            if (allKeys[index] === "size$DRP$long") {
                                                                                if (item.cond[allKeys[index]] !== newVal["size$DRP$long"]) {
                                                                                    condFlag = false;
                                                                                    break;
                                                                                }
                                                                            } else if (allKeys[index] === "gsize$DRP$long") {
                                                                                if (item.cond[allKeys[index]] !== newVal["gsize$DRP$long"]) {
                                                                                    condFlag = false;
                                                                                    break;
                                                                                }
                                                                            } else if (!(allKeys[index] in item.cond) || item.cond[allKeys[index]] !== newVal[allKeys[index]]) {
                                                                                condFlag = false;
                                                                                break;
                                                                            }
                                                                        }
                                                                        if (condFlag === true) {
                                                                            //If condition is matched check for options
                                                                            if (item.res !== undefined && item.res !== null && field.model in item.res) {
                                                                                newElement.removeAttr('ng-options');
                                                                                var arrr = [];
                                                                                //Make array of new options
                                                                                for (var i = 0; i < item.res[field.model].length; i++) {
                                                                                    arrr.push(item.res[field.model][i].text);
                                                                                }
                                                                                //If currently selected option is not in the new list, than update select value with blank value
                                                                                if (arrr.indexOf($('#' + field.modelWithoutSeperators + " option:selected").text()) === -1) {
                                                                                    var scope = angular.element('#' + field.modelWithoutSeperators).scope();
                                                                                    scope.outputData[field.model] = "";
                                                                                }
                                                                                //For each option of the select check if it is not in the list than hide that option
                                                                                $('#' + field.modelWithoutSeperators + " option").each(function () {
                                                                                    if (arrr.indexOf($(this).text()) === -1 && $(this).text() !== "Select") {
                                                                                        $(this).hide();
                                                                                    }
                                                                                });
                                                                            }
                                                                            //check for default value
                                                                            if (item.def !== undefined && item.def !== null && field.model in item.def) {
                                                                                var arrr1 = [];
                                                                                //Make array of options
                                                                                $('#' + field.modelWithoutSeperators + " option").each(function () {
                                                                                    arrr1.push($(this).text());
                                                                                });
                                                                                $('#' + field.modelWithoutSeperators + " option").each(function () {
                                                                                    if (arrr1.indexOf($(this).text()) === -1 && $(this).text() !== "Select") {
                                                                                    } else {
                                                                                        //Check if option's text and given defualt option's text is same than select that option using jquery and update model value with new value
                                                                                        if ((field.model in item.def) && $(this).text() === item.def[field.model]["text"]) {
                                                                                            var scope = angular.element('#' + field.modelWithoutSeperators).scope();
                                                                                            if (newVal !== oldVal && newVal.carat_type$DRP$Long === oldVal.carat_type$DRP$Long) {
                                                                            ...
                                                                            //If condition not full filled than show all the option
                                                                            $('#' + field.modelWithoutSeperators + " option").each(function () {
                                                                                $(this).show();
                                                                            });
                                                                        }
...
//                                                                //console.log('formula array after : ' + formulaArray);
...
//                                                newElement.attr('placeholder', "AutoGenerated");
                                                newElement.attr('ng-model', attrs.ngModel + "['" + field.model + "']");
                                                if (angular.isDefined(field.attributes) && angular.isDefined(field.attributes.maxLength)) {
...
//                                                    console.log("attrs.beforeLabel :" + attrs.beforeLabel)
                                                    if (((attrs.beforeLabel !== null && attrs.beforeLabel !== undefined) || (attrs.afterLabel !== null && attrs.afterLabel !== undefined) || field.isBarcodeRequired)) {
                                                        if ((attrs.beforeLabel !== null && attrs.beforeLabel !== undefined) || (attrs.afterLabel !== null && attrs.afterLabel !== undefined)) {
                                                        ...
                                                        if (attrs.beforeLabel !== null && attrs.beforeLabel !== undefined) {
                                                        ...
                                                        if (attrs.afterLabel !== null && attrs.afterLabel !== undefined) {
                                                            var spansTag = angular.element('<span class="form-control col-md-5 input-group-addon" style=\"width:45%;padding-top: 9px;padding-right:0px;padding-left:0px\">{{' + attrs.afterLabel + '}}</span>');
...
//                                                newElement.attr('ng-model', attrs.ngModel + "['" + field.model + "@CurrencyValue']");
                                                ...
                                                else
                                                {
                                                    ...
                                                    /* This scenario will be if I create a document at that time there was no currency component but now I add a component and then if i edit
                                                     if it does not have value in mongo bring it from postgres */
                                                    if ($scope[attrs.ngModel][field.model + "*CurrencyCode"] === undefined)
                                                    {
                                                        model[codeVal] = field.currencyCode;
                                                    }
                                                }
...
//                                            newElement.attr('currencyallowed', true);
                                                ...
                                                if (angular.isDefined($scope.screenRules[field.model])) {
                                                    eXRTextElement.attr('style', 'background-color:' + $scope.screenRules[field.model].colorCode);
                                                }
                                                else if (angular.isDefined(field.backgroundColor)) {
                                                    eXRTextElement.attr('style', 'background-color:' + field.backgroundColor + "; color:#000000");
                                                } else {
                                                    eXRTextElement.removeAttr('style');
                                                }
...
//                                            newElement.attr('ng-required', true);
                                            ...
                                            if (field.type === 'imageUpload')
                                            {
                                                ...
                                                $scope.$watch(temp, function () {
                                                    ...
                                                    if (attrs.isDiamond === true)
                                                    {
                                                        $scope[img] = rootScope.appendAuthToken(rootScope.centerapipath + "fileUpload/getimage?file_name=" + a);
                                                    } else
                                                    {

                                                        $scope[img] = rootScope.appendAuthToken(rootScope.apipath + "fileUpload/getimage?file_name=" + a);
                                                        ////console.log("in else...." + $scope[img]);
                                                    }
                                                });
                                            }
                                                                        ...
                                                                        if (dependentConstraintValue !== null && dependentConstraintValue !== undefined)
                                                                        {
                                                                            ...
                                                                            if (field.type === 'date')
                                                                            {
                                                                                ...
                                                                                if (dependantDbfieldModelValueDate !== null && dependantDbfieldModelValueDate !== undefined) {
                                                                                    ...
                                                                                    // //console.log("first" + firstDependantDate + "sec..." + secondDependantDate)
...
//                                                                                    
                                                                            ...
                                                                            } else
                                                                            {
                                                                                ...
                                                                                var dependantDbfieldModelValue = $scope[dependantDbFieldName];
                                                            ...
                                                            {
// Forward Scenario
                                                                $scope[field.model] = $scope[attrs.ngModel][field.model];
...
//                                                            $scope['constr@' + field.model] = messageForConstraint;
...
//                                        if (!attrs.viewOnly) {
                                                ...
                                                //  Button elements get their labels from their contents.
                                                    ...
                                                    newElement.html(rootScope.translateValue("CSTMFLD_NM." + field.label));
                                                } else {
...
//                                            }
                                                    var tmpl = $parse(attrs.template)($scope);
                                                    if (mainDiv === null && elementPerRow <= 10) {
                                                        mainDiv = angular.element('<div class="form-group" style="margin-left: 0px;margin-right: 0px;"></div>');
                                                    } else if (mainDiv === null && elementPerRow > 10) {
                                                        mainDiv = angular.element('<div class="form-group"  style="width:' + tmpl.length * 10 + '%;margin-left: 0px;margin-right: 0px;"></div>');
                                                    }
...
//                                                        newElement = newElement.wrap('<div class="col-lg-11 col-md-11 col-xs-12"></div>').parent();
                                                    ...
                                                    {
                                                        var divvElement = angular.element('<div id="const_' + field.modelWithoutSeperators + '" class="text-danger error,help-block col-xs-12 hkg-nopadding ng-hide" > Invalid value constraint </div>');
                                                    ...
                                                    if (field.type === 'imageUpload') {
                                                        if (elementPerRow === 2) {
                                                            if (attrs.viewOnly)
                                                            {
                                                                newElement = newElement.wrap('<div  id="dv_view_' + field.modelWithoutSeperators + '" ng-controller="ImageUploadController" class="col-lg-6 col-md-6 col-xs-12  " style="padding-left:0px;padding-right:0px " ></div>').parent();
                                                            } else {
                                                        ...
                                                        if (elementPerRow === 3) {
                                                            if (attrs.viewOnly) {
                                                                newElement = newElement.wrap('<div  id="dv_view_' + field.modelWithoutSeperators + '" ng-controller="ImageUploadController" class="col-lg-4 col-md-4 col-xs-12 " style="padding-left:0px;padding-right:0px "></div>').parent();
                                                            } else {
                                                        ...
                                                        if (elementPerRow > 3) {
                                                            var tmpl = $parse(attrs.template)($scope);
                                                            if (tmpl.length < elementPerRow) {
                                                                var wid = 100 / tmpl.length;
                                                            } else {
                                                                var wid = 100 / elementPerRow;
                                                            }
                                                            if (attrs.viewOnly) {
                                                                newElement = newElement.wrap('<div  id="dv_view_' + field.modelWithoutSeperators + '" ng-controller="ImageUploadController"  style="position: relative;min-height: 1px;float: left;width: ' + wid + '%; padding-left:5px;padding-right:5px ng-hide"></div>').parent();
                                                            } else {
                                                                newElement = newElement.wrap('<div  id="dv_' + field.modelWithoutSeperators + '"   style="position: relative;min-height: 1px;float: left;width: ' + wid + '%; padding-left:5px;padding-right:5px ng-hide"></div>').parent();
                                                            }
                                                            if (field.isDependant)
                                                            {
                                                                newElement.addClass('ng-hide');
                                                    ...
                                                    if (field.type !== 'checkbox' && field.type !== 'imageUpload') {
                                                        if (elementPerRow === 2) {
                                                            if (attrs.viewOnly)
                                                            {
                                                        ...
                                                        if (elementPerRow > 3) {
                                                            ...
                                                            if (attrs.viewOnly) {
                                                                newElement = newElement.wrap('<div  id="dv_view_' + field.modelWithoutSeperators + '"   style="position: relative;min-height: 1px;float: left;width: ' + wid + '%; padding-left:5px;padding-right:5px ng-hide"></div>').parent();
                                                            } else {
                                                                newElement = newElement.wrap('<div  id="dv_' + field.modelWithoutSeperators + '"   style="position: relative;min-height: 1px;float: left;width: ' + wid + '%; padding-left:5px;padding-right:5px ng-hide"></div>').parent();
                                                            }
                                                            if (field.isDependant)
...
//                                                                 
                                                            ...
                                                            if (elementPerRow === 2) {
                                                                var divElement = angular.element(' <div ng-show="(' + attrs.formName + '.' + field.model + '.$dirty || ' + submitFlagName + ') && ' + attrs.formName + '.' + field.model + '.$invalid" class="error,help-block col-xs-12 hkg-nopadding" style="position: relative;left: 38%;" ></div>');
                                                            }
                                                            if (elementPerRow === 3) {
                                                                var divElement = angular.element(' <div ng-show="(' + attrs.formName + '.' + field.model + '.$dirty || ' + submitFlagName + ') && ' + attrs.formName + '.' + field.model + '.$invalid" class="error,help-block col-xs-12 hkg-nopadding" style="position: relative;left: 6%;" ></div>');
                                                            }
                                                            if (elementPerRow === 10) {
                                                                var divElement = angular.element(' <div ng-show="(' + attrs.formName + '.' + field.model + '.$dirty || ' + submitFlagName + ') && ' + attrs.formName + '.' + field.model + '.$invalid" class="error,help-block col-xs-12 hkg-nopadding" style="position: relative;left: 10%;" ></div>');
                                                            }
...
//                                                                 
                                                            ...
                                                            if (elementPerRow >= 3 && elementPerRow <= 5) {
                                                                var labelElement = angular.element('<label for="' + field.model + '" class="col-md-4 control-label" style="text-align:left"></label>');
                                                            }
                                                            else if (elementPerRow > 5) {
                                                                var labelElement = angular.element('<label for="' + field.model + '" class="col-md-12 control-label" style="text-align:left; padding-left:0px; padding-right:0px"></label>');
...
//                                            }
                                                        if (mainDiv === null) {
                                                            mainDiv = angular.element('<div id="dv_' + field.modelWithoutSeperators + '" ></div>');
                                                        }

                                                        if (field.type !== 'checkbox' && !(field.type === 'date' && field.attributes && (field.attributes.type === 'timerange' || field.attributes.type === 'datetimerange' || field.attributes.type === 'daterange'))) {
                                                            newElement = newElement.wrap('<div ng-class="{\'has-error\': ' + attrs.formName + '.' + field.model + '.$invalid && (' + submitFlagName + ') }" class="' + attrs.inputCss + '"></div>').parent();
                                                        } else if ((!attrs.noOfFieldPerRow || attrs.noOfFieldPerRow === 1) && field.type !== 'checkbox') {
                                                            newElement = newElement.wrap('<div class="' + attrs.inputCss + '"></div>').parent();
                                                        } else if (field.type === 'checkbox') {
                                                            if (field.formatValue === 'before') {
                                                                newElement = newElement.wrap('<div ng-class="{\'has-error\': ' + attrs.formName + '.' + field.model + '.$invalid && (' + submitFlagName + ') }" class="' + attrs.labelCss + '"></div>').parent();
                                                            } else if (field.formatValue === 'after') {
                                                                newElement = newElement.wrap('<div ng-class="{\'has-error\': ' + attrs.formName + '.' + field.model + '.$invalid && (' + submitFlagName + ') }" class="' + attrs.inputCss + '"></div>').parent();
                                                            }
                                                        }
                                                        ...
                                                        if (angular.isDefined(field.required) && field.required === true) {
                                                            ...
                                                            if (field.type === 'checkbox') {
                                                                if (field.formatValue === "before") {
                                                                    ...
                                                                    var firstElement = angular.element('<div class="form-group"></div>');
...
//                                                labelElement = labelElement.append(document.createTextNode(field.label + ''));
//                                                newElement = newElement.prepend(labelElement);
                                                                labelElement = labelElement.append(rootScope.translateValue("CSTMFLD_NM." + field.label));
                                                                if (angular.isDefined(wrapElement)) {
                                                                    labelElement = wrapElement.append(labelElement);
...
//                                                            labelElement = labelElement.append(hintElement);
                                                    ...
                                                    if (mainDiv === null) {
                                                        ...
                                                        mainDiv = angular.element('<div id="ss1" class="form-group row"></div>');
                                                    }
                                                    var labelElement = angular.element('<label for="' + field.model + '"class="' + attrs.labelCss + ' wordRap"></label>');
//                                                labelElement = labelElement.prepend(document.createTextNode(field.label + ' '));
...
//                                        }
                            ...
                            var modal = '<div class="modal fade" role="dialog" id="galleryPopup" tabindex="-1" aria-hidden="true" >' +
                                    '<div class="modal-dialog">' +
                                    ' <div class="row">' +
                                    '<div>' +
                                    '<div id="checks" class="slider-gallery">' +
                                    "<img class='slide-gallery img-responsive' style='height: 100%;width: 100%' ng-src='api/fileUpload/getimage?file_name={{imageFileNamePopup}}&token={{authToken}}' />" +
                                    '<a class="close" href="" style="color: white;" ng-click="hideImagePopup()">&times;</a>' +
                                    '</div>    ' +
                                    '</div>' +
                                    '</div>' +
                                    '</div>' +
                ...
                render();
                var retrieveholidayList = function ()
                {
                    var holidayService;
                    ...
                    holidayService.retrieveAllHoliday(function (response) {
                        //console.log("Holiday resposne...." + JSON.stringify(response))
                        $scope.holidayList = [];
                        if (response.data !== null && response.data !== undefined) {
                            angular.forEach(response.data, function (date) {
                                $scope.holidayList.push(new Date(date));
                            });
                            //console.log("holiday list in method..." + JSON.stringify($scope.holidayList))
                        }
                    }, function (res) {
                    });
                }
                var dependantView = function () {
                    ...
                    if (colorElementsForUISelect !== null && colorElementsForUISelect !== undefined)
                    {
                        angular.forEach(colorElementsForUISelect, function (colorElements)
                        {
                            ...
                            // s2id is autogenerated by select2.js
                    ...
                    ;
                    //console.log("in dependant view")
//document.getElementById("s2id_user").firstChild.css('background-color','#0000ff');
//                    $("#s2id_user ul").css('background-color', '#0000ff');
//
                    $('.select2-selection-limit').removeAttr('background');
//                     $('.select2-choices').css('background-color','#0000ff');
//                    $('.select2-choices').removeAttr('margin');
                    //console.log($('.select2-selection-limit'))
                };
                function isFloat(n) {
                    //console.log("n" + n);
...
//                        }
    ...
    globalProvider.controllerProvider.register('FileUploadController', ["$rootScope", "$scope",
        "fileuploadservice", "fileuploadservicemaster", "$attrs", function ($rootScope, $scope,
    ...
    globalProvider.controllerProvider.register('TextController', ["$rootScope", "$scope",
        "CenterCustomFieldService", "$attrs", "CustomHolidayService", "CenterCustomHolidayService", function ($rootScope, $scope,
            ...
            $scope.checkUniqueness = function (value, featureName, element) {
            ...
            {
                // //console.log("map...hereeee." + value)
            }

        }]);
//    globalProvider.controllerProvider.register('DefaultController', ["$rootScope", "$scope",
//        "CenterCustomFieldService", "$attrs", "CustomHolidayService", "CenterCustomHolidayService", function ($rootScope, $scope,
//                CenterCustomFieldService, attrs, CustomHolidayService, CenterCustomHolidayService) {
//            $scope.defineLabel = function (fieldModel, featureName, isDiamond, editFlag, isDate, skipHolidays)
//            {
//                //console.log('defined----' + fieldModel + featureName + isDiamond + editFlag + "9999" + isDate + "888" + skipHolidays);
...
//        }
//    ]);
    globalProvider.controllerProvider.register('ImageUploadController', ["$rootScope", "$scope",
        "fileuploadservice", "fileuploadservicemaster", "$attrs", function ($rootScope, $scope,
                fileuploadservice, fileuploadservicemaster, attrs) {
            $scope.defineLabel = function (isDiamond)
            {
            ...
            $scope.showImagePopup = function (imageFileName) {
                if (imageFileName !== undefined) {
                    var imageFinalString = imageFileName.substring(0, imageFileName.lastIndexOf("_"));
    ...
    globalProvider.controllerProvider.register('MultiSelectController', ["$rootScope", "$scope",
        "DynamicMasterService", "DynamicCenterMasterService", function ($rootScope, $scope,
    ...
    globalProvider.controllerProvider.register('UserMultiSelectController', ["$rootScope", "$scope", "UserManagementService", "CenterCustomFieldService", function ($rootScope, $scope,
    ...
    globalProvider.controllerProvider.register('UserSingleSelectController', ["$rootScope", "$scope", "UserManagementService", "CenterCustomFieldService", function ($rootScope, $scope,
                UserManagementService, CenterCustomFieldService) {
...
////console.log("carr"+carrierBoyDes)
...
//                        //console.log("in carrier boye")
                    ...
                    {
//                        //console.log("in allot" + $scope.desgnationIdForAllot)
...
//                        //console.log("no did");
                    ...
                    if ($scope.designationId !== null && $scope.designationId !== undefined && $scope.designationId !== '') {
                        var search;
//                        //console.log("yes did" + $scope.designationId)
                        var searchEmp = false;
                        if ($scope.isDep === false && $scope.isDeg === false && $scope.isFran === false)
                        {
                            if (selected.substring(0, 2) === '@E' || selected.substring(0, 2) === '@e') {
                        ...
                        if (searchEmp === true) {
                            if ($scope.isDynamic !== null && $scope.isDynamic !== undefined) {
                                ...
                                //                                //console.log('here : ' + JSON.stringify(queryParam));
    ...
    globalProvider.controllerProvider.register('SingleSelectController', ["$rootScope", "$scope",
        "DynamicMasterService", "CaratRangeService", "AssetCustomService", "CenterCustomFieldService", "DynamicCenterMasterService", "$timeout", function ($rootScope, $scope,
            ...
            {
                $scope.valss = false;
                //console.log("on page load...." + $scope.valss)
                $scope.defaultValue = defaultValue;
                $scope.model = model;
                $scope.attribute = attribute;
                $scope.dropdown = [];
...
//                     
            ...
            $scope.changeData = function (model)
            {
                ...
                $scope.valss = false;
                //console.log("changed data called" + $scope.valss)
//                $timeout(function () {
//                $scope.   valss = true;
                //console.log("true hua" + $scope.valss)
//                }, 1);
            }
    ...
    globalProvider.controllerProvider.register('SubEntityController', ["$rootScope", "$scope",
    ...
    globalProvider.controllerProvider.register('CurrencyController', ["$rootScope", "$scope",
        "CurrencyService", "CenterCustomFieldService", function ($rootScope, $scope,
    ...
    globalProvider.controllerProvider.register('ReferenceRateController', ["$rootScope", "$scope",
        "CurrencyService", "CenterCustomFieldService", function ($rootScope, $scope,
                CurrencyService, CenterCustomFieldService) {
            $scope.fillReferenceRateForCurrency = function (currency, model, attribute, isDiamond)
            {
                ...
                if ($scope.isDiamond === true || $scope.isDiamond === 'true') {
                    ...
                    // Master call
                    //console.log('in master call')
                    CurrencyService.retrieveReferenceRateForCurrency(currency, success, failure);
                }
    ...
    globalProvider.provide.factory('CurrencyService', ['$resource', '$rootScope', function (resource, rootScope) {
            var customfieldManagment = resource(rootScope.apipath + 'currencymaster/:action', {}, {
                ...
                retrieveReferenceRateForCurrency: {
                    method: 'POST',
                    isArray: false,
                    params: {
                        action: 'retrieveReferenceRateForCurrency'
                    }
                }
            });
            return customfieldManagment;
