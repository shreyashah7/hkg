...
angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.transition", "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.bindHtml", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.position", "ui.bootstrap.datepicker", "ui.bootstrap.dropdown", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.tpls", ["template/accordion/accordion-group.html", "template/accordion/accordion.html", "template/alert/alert.html", "template/carousel/carousel.html", "template/carousel/slide.html", "template/datepicker/datepicker.html", "template/datepicker/day.html", "template/datepicker/month.html", "template/datepicker/popup.html", "template/datepicker/year.html", "template/modal/backdrop.html", "template/modal/window.html", "template/pagination/pager.html", "template/pagination/pagination.html", "template/tooltip/tooltip-html-unsafe-popup.html", "template/tooltip/tooltip-popup.html", "template/popover/popover.html", "template/progressbar/bar.html", "template/progressbar/progress.html", "template/progressbar/progressbar.html", "template/rating/rating.html", "template/tabs/tab.html", "template/tabs/tabset.html", "template/timepicker/timepicker.html", "template/typeahead/typeahead-match.html", "template/typeahead/typeahead-popup.html"]), angular.module("ui.bootstrap.transition", []).factory("$transition", ["$q", "$timeout", "$rootScope", function(e, t, n) {
            ...
            function o() {
                if (!p) {
                    if (s.currentSlide && angular.isString(r) && !e.noTransition && i.$element) {
                        ...
                        }), angular.extend(i, {direction: r, active: !0, entering: !0}), angular.extend(s.currentSlide || {}, {direction: r, leaving: !0}), e.$currentTransition = n(i.$element, {}), function(t, n) {
    ...
    return{require: "^carousel", restrict: "EA", transclude: !0, replace: !0, templateUrl: "template/carousel/slide.html", scope: {active: "=?"}, link: function(e, t, n, a) {
        ...
        function n(e) {
            ...
            return angular.forEach(i, function(t, i) {
                var r = e.indexOf(i), o = t.apply, l = t.regex;
                if ("dd" === i && (l = "0?[1-2]?[0-9]{1}|3[0-1]{1}"), "MM" === i && (l = "0?[1-9]|1[0-2]"), "yyyy" === i && (l = "(?:[0-9]{2})?[0-9]{2}", o = function(e) {
                    this.year = 2 === e.length ? +e + 2e3 : +e
                }), r > -1) {
                    e = e.split(""), a[r] = "(" + l + ")", e[r] = "$";
                    for (var s = r + 1, c = r + i.length; c > s; s++)
                        a[s] = "", e[s] = "$";
                    e = e.join(""), n.push({index: r, apply: o})
                }
        ...
        this.modes = ["day", "month", "year"], angular.forEach(["formatDay", "formatMonth", "formatYear", "formatDayHeader", "formatDayTitle", "formatMonthTitle", "minMode", "maxMode", "showWeeks", "startingDay", "yearRange"], function(n, i) {
            s[n] = angular.isDefined(t[n]) ? 8 > i ? a(t[n])(e.$parent.$parent) : e.$parent.$parent.$eval(t[n]) : l[n]
        }), angular.forEach(["min", "max"], function(a) {
            t[a] ? e.$parent.$parent.$watch(n(t[a]), function(e) {
                s[a] = e ? new Date(e) : null, s.refreshView()
            }) : s[a] = l[a] ? new Date(l[a]) : null
        }), e.datepickerMode = e.datepickerMode || l.datepickerMode, e.uniqueId = "datepicker-" + e.$id + "-" + Math.floor(1e4 * Math.random()), this.activeDate = angular.isDefined(t.initDate) ? e.$parent.$parent.$eval(t.initDate) : new Date, e.isActive = function(t) {
            ...
            if (c.$modelValue) {
                var n = new Date(c.$modelValue), a = !isNaN(n);
                a ? this.activeDate = n : r.error('Datepicker directive: "ng-model" value must be a Date object, a number of milliseconds since 01.01.1970 or a string representing an RFC2822 or ISO 8601 date.'), c.$setValidity("date", a)
            } else
                this.activeDate = angular.isDefined(t.initDate) ? e.$parent.$parent.$eval(t.initDate) : new Date;
            this.refreshView()
            ...
            return this.min && this.compare(n, this.min) < 0 || this.max && this.compare(n, this.max) > 0 || t.dateDisabled && e.dateDisabled({date: n, mode: e.datepickerMode})
    ...
    return{restrict: "EA", replace: !0, templateUrl: "template/datepicker/datepicker.html", scope: {datepickerMode: "=?", dateDisabled: "&", isOpen: "=?"}, require: ["datepicker", "?^ngModel"], controller: "DatepickerController", link: function(e, t, n, a) {
            var i = a[0], r = a[1];
            r && i.init(r)
        }}
        ...
        return{restrict: "EA", replace: !0, templateUrl: "template/datepicker/day.html", require: "^datepicker", link: function(t, n, a, i) {
                ...
                i._refreshView = function() {
                    ...
                    for (var p = o(u, 42), d = 0; 42 > d; d++)
                        p[d] = angular.extend(i.createDateObject(p[d], i.formatDay), {secondary: p[d].getMonth() !== a, uid: t.uniqueId + "-" + d});
                    t.labels = new Array(7);
                    for (var g = 0; 7 > g; g++)
                        t.labels[g] = {abbr: e(p[g].date, i.formatDayHeader), full: e(p[g].date, "EEEE")};
        ...
        return{restrict: "EA", replace: !0, templateUrl: "template/datepicker/month.html", require: "^datepicker", link: function(t, n, a, i) {
                i.step = {years: 1}, i.element = n, i._refreshView = function() {
                    for (var n = new Array(12), a = i.activeDate.getFullYear(), r = 0; 12 > r; r++)
                        n[r] = angular.extend(i.createDateObject(new Date(a, r, 1), i.formatMonth), {uid: t.uniqueId + "-" + r});
        ...
        return{restrict: "EA", replace: !0, templateUrl: "template/datepicker/year.html", require: "^datepicker", link: function(e, t, n, a) {
                ...
                a.step = {years: r}, a.element = t, a._refreshView = function() {
                    for (var t = new Array(r), n = 0, o = i(a.activeDate.getFullYear()); r > n; n++)
                        t[n] = angular.extend(a.createDateObject(new Date(o + n, 0, 1), a.formatYear), {uid: e.uniqueId + "-" + n});
        ...
        return{restrict: "EA", require: "ngModel", scope: {isOpen: "=?", currentText: "@", clearText: "@", closeText: "@", dateDisabled: "&"}, link: function(l, s, c, u) {
                ...
                function d(e) {
                    if (u.$setValidity("min", !0), u.$setValidity("max", !0), u.$setValidity("date", !0), e) {
                        if (angular.isDate(e) && !isNaN(e))
                            return u.$setValidity("date", !0), void 0 !== l.watchData.min && e >= new Date(l.watchData.min).setHours(0, 0, 0, 0) && u.$setValidity("min", !0), void 0 !== l.watchData.max && e <= new Date(l.watchData.max).setHours(0, 0, 0, 0) && u.$setValidity("max", !0), e;
                        if (angular.isString(e) || !isNaN(e)) {
                            var t = r.parse(e, g);
                            if (isNaN(t))
                                return void u.$setValidity("date", !1);
                            if (l.watchData.min && t < new Date(l.watchData.min).setHours(0, 0, 0, 0))
                                return void u.$setValidity("min", !1);
                            if (l.watchData.max) {
                                var n = new Date(new Date(l.watchData.max).setHours(0, 0, 0, 0));
                                if (n = n.setDate(n.getDate() + 1), t > n)
                                    return void u.$setValidity("max", !1)
                            }
                            return t
                        }
                        return void u.$setValidity("date", !1)
                    }
                    return void u.$setValidity("date", !0)
                }
                ...
                l.showButtonBar = angular.isDefined(c.showButtonBar) ? l.$parent.$eval(c.showButtonBar) : o.showButtonBar, l.popup = {}, l.getText = function(e) {
                    return l[e + "Text"] || o[e + "Text"]
                }, c.$observe("datepickerPopup", function(e) {
                    g = e || o.datepickerPopup, u.$render()
                });
                var h = angular.element('<div datepicker-popup-wrap><div datepicker is-open="isOpen"></div></div>');
                h.attr({"ng-model": "popup.date", "ng-change": "dateSelection()"});
                var v = angular.element(h.children()[0]);
                c.datepickerOptions && angular.forEach(l.$parent.$eval(c.datepickerOptions), function(e, t) {
                    v.attr(p(t), e)
                }), l.watchData = {}, angular.forEach(["min", "max", "datepickerMode"], function(e) {
                    if (c[e]) {
                        var n = t(c[e]);
                    ...
                    angular.isDefined(e) && (l.popup.date = e), u.$setViewValue(l.popup.date), u.$render(), m && (l.isOpen = !1, s[0].focus())
                }, s.bind("input change keyup", function() {
                    l.$apply(function() {
                        l.popup.date = u.$modelValue
                    })
                }), u.$render = function() {
                    var e = u.$viewValue ? i(u.$viewValue, g) : "";
                    s.val(e), l.popup.date = d(u.$modelValue)
                };
                var b = function(e) {
                ...
                h.remove(), f ? n.find("body").append(y) : s.after(y), l.$on("$destroy", function() {
                    y.next().remove(), s.unbind("keydown", $), n.unbind("click", b)
                })
            }}
    ...
    return{restrict: "CA", controller: "DropdownController", link: function(e, t, n, a) {
            a.init(t)
        }}
}).directive("dropdownToggle", function() {
    return{restrict: "CA", require: "?^dropdown", link: function(e, t, n, a) {
            if (a) {
                a.toggleElement = t;
                var i = function(i) {
    ...
    this.options = function(e) {
        ...
        angular.extend(n, e)
            ...
            return function(p, d, g) {
                function m(e) {
                    var t = e || f.trigger || g, a = n[t] || t;
                    return{show: t, hide: a}
                }
                var f = angular.extend({}, t, a), h = e(p), v = u.startSymbol(), b = u.endSymbol(), $ = "<div " + h + '-popup title="' + v + "tt_title" + b + '" content="' + v + "tt_content" + b + '" placement="' + v + "tt_placement" + b + '" animation="tt_animation" is-open="tt_isOpen"></div>';
                return{restrict: "EA", scope: !0, compile: function() {
                        ...
                        return function(t, n, a) {
                            ...
                            function u() {
                                (!T || t.$eval(a[d + "Enable"])) && (t.tt_popupDelay ? x || (x = o(h, t.tt_popupDelay, !1), x.then(function(e) {
                                    e()
                                })) : h()())
                            }
                            function g() {
                            ...
                            function h() {
                                if (x = null, k && (o.cancel(k), k = null), !t.tt_content)
                                    return angular.noop;
                                b(), w.css({top: 0, left: 0, display: "block"}), D ? s.find("body").append(w) : n.after(w);
                                var e = window.innerWidth || document.documentElement.clientWidth, a = y(n);
                                return a.left > e - (w.prop("offsetWidth") || 200) && (t.tt_placement = "left"), C(), t.tt_isOpen = !0, t.$digest(), C
                            }
                            function v() {
                                t.tt_isOpen = !1, o.cancel(x), x = null, t.tt_animation ? k || (k = o($, 500)) : $()
                            }
                            function b() {
                                w && $(), w = e(t, function() {
                                }), t.$digest()
                            ...
                            function $() {
                                k = null, w && (w.remove(), w = null)
                            }
                            function y(e) {
                                var t = e[0].getBoundingClientRect();
                                return{width: t.width || e.prop("offsetWidth"), height: t.height || e.prop("offsetHeight"), top: t.top + (i.pageYOffset || s[0].documentElement.scrollTop), left: t.left + (i.pageXOffset || s[0].documentElement.scrollLeft)}
                            }
                            var w, k, x, D = angular.isDefined(f.appendToBody) ? f.appendToBody : !1, M = m(void 0), T = angular.isDefined(a[d + "Enable"]), C = function() {
                                var e = c.positionElements(n, w, t.tt_placement, D);
                                e.top += "px", e.left += "px", w.css(e)
                            };
                            t.tt_isOpen = !1, a.$observe(p, function(e) {
                                t.tt_content = e, !e && t.tt_isOpen && v()
                            }), a.$observe(d + "Title", function(e) {
                                t.tt_title = e
                            }), a.$observe(d + "Placement", function(e) {
                                t.tt_placement = angular.isDefined(e) ? e : f.placement
                            }), a.$observe(d + "PopupDelay", function(e) {
                                var n = parseInt(e, 10);
                                t.tt_popupDelay = isNaN(n) ? f.popupDelay : n
                            });
                            var E = function() {
                                n.unbind(M.show, u), n.unbind(M.hide, g)
                            };
                            a.$observe(d + "Trigger", function(e) {
                                E(), M = m(e), M.show === M.hide ? n.bind(M.show, r) : (n.bind(M.show, u), n.bind(M.hide, g))
                            });
                            var O = t.$eval(a[d + "Animation"]);
                            t.tt_animation = angular.isDefined(O) ? !!O : f.animation, a.$observe(d + "AppendToBody", function(e) {
                                D = angular.isDefined(e) ? l(e)(t) : D
                            }), D && t.$on("$locationChangeSuccess", function() {
                                t.tt_isOpen && v()
                            }), t.$on("$destroy", function() {
                                o.cancel(k), o.cancel(x), E(), $()
                            })
                        }
                    }}
            }
    ...
    return{restrict: "EA", replace: !0, transclude: !0, controller: "ProgressController", scope: {value: "=", type: "@"}, templateUrl: "template/progressbar/progressbar.html", link: function(e, t, n, a) {
        ...
        this.init = function(i) {
            ...
            for (var t = 0, n = e.length; n > t; t++)
                e[t] = angular.extend({index: t}, {stateOn: this.stateOn, stateOff: this.stateOff}, e[t]);
            return e
        }, e.rate = function(t) {
    ...
    return{restrict: "A", require: "^tabset", link: function(t, n, a) {
        ...
        e.$watch(function() {
            ...
            void 0 === t && (e.hours = null, e.minutes = null, g = new Date, g.setMinutes(0))
        ...
        t.minuteStep && e.$parent.$watch(n(t.minuteStep), function(e) {
            ...
            e.updateHours = function() {
                var e = o();
                angular.isDefined(e) ? (g.setHours(e), c("h")) : (g.setHours((new Date).getHours()), a(!0))
            }, t.bind("blur", function() {
                !e.invalidHours && e.hours < 10 && e.$apply(function() {
                    e.hours = s(e.hours), console.log("set from here")
                })
            }), e.updateMinutes = function() {
                var e = l();
                angular.isDefined(e) ? (g.setMinutes(e), c("m")) : (g.setMinutes(0), a(void 0, !0))
            ...
            var t = m.$modelValue ? new Date(m.$modelValue) : null;
            isNaN(t) ? (m.$setValidity("time", !1), a.error('Timepicker directive: "ng-model" value must be a Date object, a number of milliseconds since 01.01.1970 or a string representing an RFC2822 or ISO 8601 date.')) : (t && (g = t), u(), p(), e.firstTime = !0)
    ...
    return{restrict: "EA", require: ["timepicker", "?^ngModel"], controller: "TimepickerController", replace: !0, scope: {}, templateUrl: "template/timepicker/timepicker.html", link: function(e, t, n, a) {
            var i = a[0], r = a[1];
            e.removeRequired = n.removeRequired, r && i.init(r, t.find("input"))
        }}
        ...
        return{require: "ngModel", link: function(s, c, u, p) {
                ...
                D.attr({id: x, matches: "matches", active: "activeIdx", select: "select(activeIdx)", query: "query", position: "position"}), angular.isDefined(u.typeaheadTemplateUrl) && D.attr("template-url", u.typeaheadTemplateUrl);
                var M = function() {
                        ...
                        if (a && d)
                            if (n.length > 0) {
                                ...
                                for (var i = 0; i < n.length; i++)
                                    t[w.itemName] = n[i], k.matches.push({id: T(i), label: w.viewMapper(k, t), model: n[i]});
                ...
                p.$parsers.unshift(function(e) {
                    ...
                    var t, n, i = {};
                    i[w.itemName] = n = k.matches[e].model, t = w.modelMapper(s, i), y(s, t), p.$setValidity("editable", !0), v(s, {$item: n, $model: t, $label: w.viewMapper(s, i)}), M(), a(function() {
                        c[0].focus()
                    }, 0, !1)
    ...
    return function(t, n) {
        ...
        e.put("template/datepicker/datepicker.html", '<div><div ng-if="isOpen"><div ng-switch="datepickerMode" role="application" ng-keydown="keydown($event)">\n  <daypicker ng-switch-when="day" tabindex="0"></daypicker>\n  <monthpicker ng-switch-when="month" tabindex="0"></monthpicker>\n  <yearpicker ng-switch-when="year" tabindex="0"></yearpicker>\n</div></div></div>')
