 ...
 * 
 * It is used in constraint configuration currently.
 * 
...
define(['angular'], function () {
    globalProvider.compileProvider.directive('agSelectizeconstraints', ["$filter", function ($filter) {
        return {
            restrict: 'A',
            require: '?ngModel',
            link: function (scope, element, attrs, controller) {
                var selectize;
                scope.selectize = scope.selectizeOptionsForConstraints;
                ...
                scope.$watch('constraintIncrement', function ()
                {
                    var items = [];
