define(['hkg', 'jqueryUi', 'selectize', 'selectize.directive'], function(hkg) {
    hkg.register.controller('ConfigureFormula', ["$rootScope", "$scope", function($rootScope, $scope) {
            ...
            $scope.generateFormula = function() {
                var formula = $scope.formula.split(",");
